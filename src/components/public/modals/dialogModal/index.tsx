...
function Index(props: TypeOptions & { reject: () => void, resolve: (p: any) => void }) {
  ...
  return <View className="xm-dialog-box">
    <Popup open={show} rounded onClose={onCancel}>
      ...
      <View className="xm-dialog">
        ...
        {props.title !== null ? <View className="dialog-title s-md-2 c-gray-8">{props.title}</View> : null}
        ...
        <View className="dialog-actions">
          ...
          <Button shape="round" className="dialog-btn" openType={props.openType} color="primary" loading={loading}
